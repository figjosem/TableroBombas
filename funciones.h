...
//bool cbWrite(uint16_t event, uint16_t transactionId, void* data);
//bool cbRead(uint16_t event, uint16_t transactionId, void* data);
...
void leerDatoModbus(uint8_t id, uint16_t reg, String chat_id, uint16_t* destino = nullptr);
